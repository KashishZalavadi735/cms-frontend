...
import { getDashboardStats } from "@/services/professorService";

function ProfessorDashboardCards() {
  // Card stats
    ...
    <div className="row g-3">
        ...
        >
          <div className="d-flex justify-content-between align-items-center">
            <div>
              ...
              <h2 className="fw-bold mt-2">{stats.totalStudents}</h2>
            </div>
            <div
      ...
      <div className="col-12 col-md-6 col-lg-3">
        ...
        >
          <div className="d-flex justify-content-between align-items-center">
            <div>
              <small className="opacity-75">Head of Departments (Admin)</small>
...
export default ProfessorDashboardCards;
